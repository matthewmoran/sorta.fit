...
# Claude agent configuration — optional, references pre-configured Claude Code agents by name
export CLAUDE_AGENT="${CLAUDE_AGENT:-}"
...
export RUNNER_TRIAGE_AGENT="${RUNNER_TRIAGE_AGENT:-}"
...
export RUNNER_DOCUMENTER_AGENT="${RUNNER_DOCUMENTER_AGENT:-}"

export RUNNER_RELEASE_NOTES_AGENT="${RUNNER_RELEASE_NOTES_AGENT:-}"
